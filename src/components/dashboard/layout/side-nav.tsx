    ...
    >
      <Stack spacing={2} sx={{ p: 3 }}>
        <Box component={RouterLink} href={paths.home} sx={{ display: 'inline-flex' }}>
          <Logo color="light" height={60} width={70} />
        </Box>
      </Stack>
    ...
    <li>
      <Box
        {...(href
          ...
          : { role: 'button', onClick: items ? handleToggle : undefined })}
        sx={{
          alignItems: 'center',
          borderRadius: 1,
      ...
      >
        ...
        <Box sx={{ flex: '1 1 auto' }} onClick={handleToggle} >
          <Typography
            component="span"
        ...
        {items && <CaretCircleRight onClick={handleToggle} />}
      </Box>
      {items && (
